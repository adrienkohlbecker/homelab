...
case "$COMMAND" in
  ...
  snapshot)
    ...
    zfs snapshot "tank/arq/spouse@$NAME"
  ...
  backup)
    ...
    zfs destroy -f "tank/arq/spouse@backup-disk-$DISK"    || true
    ...
    zfs destroy -f "backup-$DISK/arq_spouse@backup-disk-$DISK"    || true
    ...
    zfs rollback -r "backup-$DISK/arq_spouse@$FROM"
    ...
    zfs snapshot "rpool/vms/ssd@backup-disk-$DISK"
    ...
    zfs snapshot "tank/arq/spouse@backup-disk-$DISK"
    ...
    zfs send -pv -I "rpool/vms/ssd@$FROM" "rpool/vms/ssd@backup-disk-$DISK" | zfs receive -v "backup-$DISK/vms_ssd"
    ...
    zfs send -pv -I "tank/arq/spouse@$FROM" "tank/arq/spouse@backup-disk-$DISK" | zfs receive -v "backup-$DISK/arq_spouse"
  ...
  destroy)
    ...
    zfs destroy "rpool/vms/ssd@$SNAPSHOT"      || true
    ...
    zfs destroy "tank/arq/spouse@$SNAPSHOT"     || true
  ...
  destroy-backup)
    ...
    zfs destroy -f "backup-$DISK/arq_spouse@$SNAPSHOT"    || true
