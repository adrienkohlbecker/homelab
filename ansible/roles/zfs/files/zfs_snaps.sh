...
case "$COMMAND" in
  ...
  backup)
    ...
    zfs destroy -f "data/arq/spouse@backup"    || true
    ...
    zfs destroy -f "backup/arq_spouse@backup"    || true
    ...
    zfs rollback -r "backup/arq_spouse@$FROM"
    ...
    zfs snapshot "data/arq/spouse@backup"
    ...
    zfs send -pv -I "data/arq/spouse@$FROM" "data/arq/spouse@backup" | mbuffer -q -s 128k -m 1G | zfs receive -v "backup/arq_spouse"
  ...
  destroy-backup)
    ...
    zfs destroy -f "backup/arq_spouse@$SNAPSHOT"    || true
