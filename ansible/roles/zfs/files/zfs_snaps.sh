...
case "$COMMAND" in
  ...
  snapshot)
    ...
    zfs snapshot "data/arq/spouse@$NAME"
  ...
  backup)
    ...
    zfs destroy -f "data/arq/spouse@backup-disk-$DISK"    || true
    ...
    zfs snapshot "data/arq/spouse@backup-disk-$DISK"
    ...
    zfs send -pv -I "data/arq/spouse@$FROM" "data/arq/spouse@backup-disk-$DISK" | mbuffer -q -s 128k -m 1G | zfs receive -v "backup-$DISK/arq_spouse"
  ...
  destroy)
    ...
    zfs destroy "data/arq/spouse@$SNAPSHOT"     || true
