...
zfs create -o mountpoint=/ rpool/xenial

sed -i 's|^GRUB_CMDLINE_LINUX=""|GRUB_CMDLINE_LINUX="root=ZFS=rpool/xenial boot=zfs rpool=rpool bootfs=rpool/xenial"|' /etc/default/grub
